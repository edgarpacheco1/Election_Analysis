...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        county_vote_count = county_votes_dict.get(county_name)

        # 6c: Calculate the percentage of votes for the county.
        countys_vote_percentage = float(county_vote_count) / float(total_votes) * 100
        county_results = (
            f"{county_name}: {countys_vote_percentage:.1f}% ({county_vote_count:,})\n")
